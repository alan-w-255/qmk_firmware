...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [5] = LAYOUT_split_3x6_3(
        //,-----------------------------------------------------.                    ,-----------------------------------------------------.
        _______, KC_TILD, KC_PERC, _______, KC_LCBR, KC_RCBR, KC_RCBR, KC_LCBR, _______, KC_PERC, KC_TILD, _______,
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
        _______, KC_GRV, KC_BSLS, _______, OSM(MOD_LSFT), CW_TOGG, CW_TOGG, OSM(MOD_LSFT), _______, KC_BSLS, KC_GRV, _______,
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
        _______, _______, KC_PIPE, _______, KC_QUOT, _______, _______, KC_QUOT, _______, KC_PIPE, _______, _______,
        //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
    ...
    [6] = LAYOUT_split_3x6_3(
        //,-----------------------------------------------------.                    ,-----------------------------------------------------.
        _______, _______, _______, KC_MPRV, KC_MNXT, _______, _______, KC_MNXT, KC_MPRV, _______, _______, _______,
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
        _______, _______, _______, KC_VOLU, KC_VOLD, KC_MPLY, KC_MPLY, KC_VOLD, KC_VOLU, _______, _______, _______,
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
const uint16_t PROGMEM mcomma_c_combo[]      = {KC_M, KC_COMM, COMBO_END};
...
const uint16_t PROGMEM dotcomma_x_combo[]    = {KC_DOT, KC_COMM, COMBO_END};
...
combo_t key_combos[] = {
    ...
    [MCOMMA_C]      = COMBO(mcomma_c_combo, KC_C),
    [JSCLN_A]       = COMBO(jscln_a_combo, KC_A),
    [ISCLN_Z]       = COMBO(iscln_z_combo, KC_Z),
    [DOTCOMMA_X]    = COMBO(dotcomma_x_combo, KC_X),
